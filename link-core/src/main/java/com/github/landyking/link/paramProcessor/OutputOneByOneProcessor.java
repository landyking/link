...
public abstract class OutputOneByOneProcessor extends AbstractParamProcessor {
    @Override
    public void processOutput(Element config, Element param, DirectiveMojo mojo, String name, List<Map<String, ValueBag>> outList) throws LinkException {
    ...
    protected abstract void processOutputOne(DirectiveMojo mojo, Element param, Element config, Map<String, ValueBag> one, String name, ValueBag item) throws LinkException;
}
